...
export default function ApprovalsHRPage(props) {
  ...
  function chargerDemandes() {
    setLoading(true);
    leaveService.getPendingHR().then(function (res) {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-lg mx-auto space-y-4">
        ...
        {loading === false && demandes.length === 0 && (
          <p className="text-sm text-gray-500">Aucune demande en attente RH.</p>
        )}
